...
(async function initAuth() {
    ...
    try {
        ...
        if (data.ok && data.user) {
            // Show auth UI, hide login button
...
(function initFaq() {
    ...
    detailsList.forEach((d) => {
        ...
        // Wrap content (all nodes after summary) into a container for height animation
...
(function revealOnScroll() {
    ...
    // Mark already visible elements immediately (e.g., footer/credits on short pages)
